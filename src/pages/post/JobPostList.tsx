    ...
    <>
        <div className="post-list-title-container">
            ...
            <div className="regist-post-button-wrapper">
                <button className="regist-post">채용공고 등록</button>
            </div>
        </div>
        <div className="view-button-container">
            <div className="view-button-wrapper">
                <button className="view-button" onClick={()=>setSelectedView('total')} >전체</button>
                <button className="view-button" onClick={()=>setSelectedView('job')}>직무별</button>
            </div>
        </div>
        ...
        <div className="post-list-contents-container">
            ...
            :filteredPostList.map((postData)=> (
                // 게시글 미리보기 카드
                <JobPostThumb postData={postData} />
            ))}
        </div>
    </>
  )
